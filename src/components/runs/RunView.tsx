      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
        ...
        <aside className="grid content-start gap-5">
          {automationEdit ? (
            <section className="glass glass-border rounded-[5px]">
              <div className="border-b border-white/[0.08] px-4 py-3">
                <h2 className="text-sm font-semibold text-white">Edit automation</h2>
                <p className="mt-1 text-xs text-white/45">Tune the spec here, then rerun from this screen.</p>
              </div>
